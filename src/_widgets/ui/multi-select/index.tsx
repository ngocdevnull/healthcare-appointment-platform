              ...
              {selectables.map((option) => {
                return (
                  <CommandPrimitive.Item
                    ...
                    className={"relative flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50"}
                  >
                    {option.label}
                  </CommandPrimitive.Item>
                )
